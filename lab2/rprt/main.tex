...
In the first of two experiments, we seek to observe the 21-cm HI line, at 1420.4 MHz. However, we want to look at frequencies better suited to our lab equipment. For example, our PicoScope has a maximum sampling rate of 62.5 MHz, so anything above 125 MHz would be aliased.
...
% We sampled in the dual channel with this DIVISOR. The DC offset between channels, as well as the amplitude differences, will help to justify the rabbit ears!
