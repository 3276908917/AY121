...
The least-squares model did not largely improve on a simple averaging of differences, but it may be coincidence that the data came out in this fashion. A simple average of the null spacings for the open 3GHz waveguide gave a wavelength of 5.00556, while a least-squares calculation gave 5.00758.

We calculated the fit for the closed waveguide to be $x_m = 5.00167 m + .43611$ and $x_m = 5.00758 m - .57667$. We also calculated the standing wave ratios to be 
