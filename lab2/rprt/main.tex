...
* Because our on-off method is arbitrary and changes as we change the Local Oscillator, the single Gaussian does not tell us much, except the rough temperature of the cloud by the width of the Gaussian. 
