...
\quad \quad We can estimate the mass of the super-massive black hole at the center of the milky way if we use Doppler velocities for our three closest angles ($\ell \in \{-1, 0, 1\}$ degrees) and integrate over radii from 0 to 44 million kilometers.
