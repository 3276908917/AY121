...
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/volt1}
	\caption{Voltage}
	\label{fig:}
\end{minipage}%
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/symp1}
	\caption{Powerish}
	\label{fig:SyPw1}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/volt2}
	\caption{Voltage}
	\label{fig:}
\end{minipage}%
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/symp2}
	\caption{Powerish}
	\label{fig:SyPw2}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/volt3}
	\caption{Voltage}
	\label{fig:Volt3}
\end{minipage}%
\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{5-2/symp3}
	\caption{Powerish}
	\label{fig:SyPw3}
\end{minipage}
\end{figure}
