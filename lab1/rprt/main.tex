...
Unfortunately, a meaningful discussion of the autocorrelation function (ACF) and its relation to the Fourier transform cannot proceed on experimental results.
...
All that sweet, sweet trig from earlier.
